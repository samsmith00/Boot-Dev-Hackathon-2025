...
pub const BOULDER_STARTING_POS: [5]rl.Vector2 = .{
    rl.Vector2.init(SCREEN_WIDTH + 15, -20),
    rl.Vector2.init(SCREEN_WIDTH + 25, 13),
    rl.Vector2.init(SCREEN_WIDTH + 17, -100),
    rl.Vector2.init(SCREEN_WIDTH - 40, -17),
    rl.Vector2.init(SCREEN_WIDTH - 15, -30),
};
